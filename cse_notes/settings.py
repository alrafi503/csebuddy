"""
Django settings for cse_notes project.
...
ROOT_URLCONF = 'cse_notes.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [BASE_DIR / 'notes/templates'],  # or templates/notes if nested
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'cse_notes.wsgi.application'
